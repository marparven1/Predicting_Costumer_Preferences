...
FALTA POST RESAMPLE aquí o solo en el mejor modelo?¿?¿?
...
Las variables mas importantes de cara a clasificar la preferencia de marca de ordenador de los clientes son: salario (100%), edad  (80.7) y crédito(3.08%)
...
Conclusiones y diferencias de lso bien y mal clasificados (variables más importantes):


- *Salario*:Menor salario máximo para los mal clasificados. El salario medio de los bien clasificados es 87074 euros muentras que el de los mal clasificados es 75374, que es un `r (round((87074-75374)/75374),2)*100`% menos.
...
```{r}
DatosIncompletosCategoricos %>% head(25)
```
