...
### Algoritmo 4: Stochastic Gradient Boosting
...
- Max Depth: 1,5,9
- Número de árboles: 3  6  9 12 15 18 21 24 27 30 33 36 39 42 45 48 51 54 57 60
- Learning rate: 0.1
...
gbmBestGrid <-  expand.grid(interaction.depth = 9, 
                        n.trees = 30, 
                        shrinkage = 0.1,
                        n.minobsinnode = 7)
