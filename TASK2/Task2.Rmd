...
```{r}
ggplot(DatosIncompletosCategoricos, aes(x = age, y = salary, color = MarcaPreferidaPred)) + geom_point()+scale_y_continuous(breaks = seq(0,150000,by=5000))+scale_x_continuous(breaks = seq(20,80,by=5))
```
