---
title: "Task 1- Get Started with R"
...
qqnorm(Cars$speed.of.car,main="Gráficos de normalidad \n Velocidad")
qqline(Cars$speed.of.car, datax = FALSE, distribution = qnorm,col="red")

qqnorm(Cars$distance.of.car,main="Distancia")
qqline(Cars$distance.of.car, datax = FALSE, distribution = qnorm,col="red")
par(mfrow=c(1,1))
```
...
```{r}
Predicciones1<- predict(modelo1,testSet)
Predicciones1
```
